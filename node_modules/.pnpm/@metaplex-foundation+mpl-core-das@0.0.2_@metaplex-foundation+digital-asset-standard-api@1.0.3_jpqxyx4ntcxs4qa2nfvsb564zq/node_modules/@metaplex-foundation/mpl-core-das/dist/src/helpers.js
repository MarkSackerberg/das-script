...
function dasAssetToCoreAssetOrCollection(dasAsset) {
    ...
    const { interface: assetInterface, id, ownership: { owner }, content: { metadata: { name }, json_uri: uri, }, compression: { seq }, grouping, authorities, plugins, unknown_plugins: unknownPlugins, executable, lamports: lamps, rent_epoch: rentEpoch, mpl_core_info: mplCoreInfo, external_plugins: externalPlugins, } = dasAsset;
