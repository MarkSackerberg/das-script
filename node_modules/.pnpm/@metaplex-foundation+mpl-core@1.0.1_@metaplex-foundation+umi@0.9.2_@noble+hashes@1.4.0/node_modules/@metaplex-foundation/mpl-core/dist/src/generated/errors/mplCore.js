...
class ExternalPluginAdapterAlreadyExistsError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('External PluginExternalPluginAdapter already exists', program, cause);
